...
bool gui::button(const std::string& name, const SDK::FVector2D& pos, const SDK::FVector2D& size, const std::wstring& tip)
{
...
void gui::set_tip(const std::wstring& wstr)
{
    if (wstr != L"")
    {
        gvalue::tip_text = wstr;
    }
}